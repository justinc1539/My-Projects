...
try:
    to_learn = pandas.read_csv("data/words_to_learn.csv").to_dict("records")
except FileNotFoundError:
    to_learn = pandas.read_csv("data/french_words.csv").to_dict("records")
...
def next_card():
    ...
    try:
        ...
        timers.append(window.after(3000, lambda: (
